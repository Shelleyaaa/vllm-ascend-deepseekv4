...
#
# Supported conditions: Linear layers with no TP communication during forward
#   - AscendReplicatedLinear: custom_op=CustomReplicatedOp or None, no communication
#   - AscendColumnParallelLinear: splittable only when gather_output=False (e.g., wq_b)
#   - Other cases automatically fall back to the full forward
#
import torch
import torch_npu
